        ...
        for (int x = 0; x < crayon.width; x++) {
            ...
            for (int sy = 0; sy < 3; sy++) {
                for (int sx = 0; sx < 3; sx++) {
                    ...
                    Vec smear_position (sx - 1, sy - 1, 0);
                    Vec canvas_smear_position = canvas_position + smear_position;
                    double smearing = smear_mask[i] ;/// total;
